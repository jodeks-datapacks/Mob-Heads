...
dialog show @s {\
  ...
  actions:[\
    ...
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mobheads:app/get_mob_head/heads/copper_golem/normal"\
      },\
      "width": 22\
    },\
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mobheads:app/get_mob_head/heads/copper_golem/exposed"\
      },\
      "width": 22\
    },\
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mobheads:app/get_mob_head/heads/copper_golem/weathered"\
      },\
      "width": 22\
    },\
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mobheads:app/get_mob_head/heads/copper_golem/oxidized"\
      },\
      "width": 22\
    },\
    {\
