...
# Changes
  ...
  # Nautilus
    data modify storage mobheads:root nautilus set value 0.01
    data modify storage mobheads:root nautilus_init set value 0.01
    scoreboard players set &nautilus mobheads.drop_notification 1
    data modify storage mobheads:root drop_notification_nautilus set value 1
    ...
    scoreboard players set &nautilus mobheads.rarity 1
    data modify storage mobheads:root rarity_nautilus set value 1
    data modify storage mobheads:root dialog_rarity_nautilus set value "$(dialog_rarity_nautilus)"

  # Parched
    data modify storage mobheads:root parched set value 0.01
    data modify storage mobheads:root parched_init set value 0.01
    scoreboard players set &parched mobheads.drop_notification 1
    data modify storage mobheads:root drop_notification_parched set value 1
    ...
    scoreboard players set &parched mobheads.rarity 1
  ...
  # Zombie Nautilus
    data modify storage mobheads:root zombie_nautilus set value 0.01
    data modify storage mobheads:root zombie_nautilus_init set value 0.01
    scoreboard players set &zombie_nautilus mobheads.drop_notification 1
    data modify storage mobheads:root drop_notification_zombie_nautilus set value 1
    ...
    scoreboard players set &zombie_nautilus mobheads.rarity 1
    data modify storage mobheads:root rarity_zombie_nautilus set value 1
    data modify storage mobheads:root dialog_rarity_zombie_nautilus set value "$(dialog_rarity_zombie_nautilus)"

  # Camel Husk
    data modify storage mobheads:root camel_husk set value 0.03
    data modify storage mobheads:root camel_husk_init set value 0.03
    scoreboard players set &camel_husk mobheads.drop_notification 1
    data modify storage mobheads:root drop_notification_camel_husk set value 1
    ...
    scoreboard players set &camel_husk mobheads.rarity 1
    data modify storage mobheads:root rarity_camel_husk set value 1
