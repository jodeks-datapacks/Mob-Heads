...
dialog show @s {\
  ...
  "body": {\
    ...
    "contents": [\
      {\
        "translate": "mob_heads.get_head.desc",\
        "fallback": "Click on a head and click \"Run Command\"",\
        "extra": [\
          "\n",\
          "\n",\
          {\
            "translate": "mob_heads.get_head.desc.close",\
  ...
  actions:[\
    ...
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads:app/get_mob_head/heads/camel_husk"\
      },\
      "width": 22\
    },\
    {\
    ...
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads:app/get_mob_head/heads/nautilus"\
      },\
      "width": 22\
    },\
    {\
    ...
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads:app/get_mob_head/heads/parched"\
      },\
      "width": 22\
    },\
    {\
    ...
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads:app/get_mob_head/heads/zombie_nautilus"\
      },\
      "width": 22\
    },\
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads:app/get_mob_head/heads/zombie_nautilus_coral"\
      },\
      "width": 22\
    },\
    {\
    ...
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads:app/get_mob_head/heads/baby/nautilus"\
      },\
      "width": 22\
    },\
    {\
