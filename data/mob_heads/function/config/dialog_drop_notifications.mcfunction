...
type:"minecraft:multi_action",\ 
  ...
  "body": [\
    {\
      ...
      "contents": {\
        "translate": "mob_heads.config.drop_notifications.description",\
  ...
  [\
    ...
    {\
      type:"minecraft:boolean",\
      key:"dialog_drop_notification_sulfur_cube",\
      label: {\
      ...
      initial:$(drop_notification_sulfur_cube),\
      on_true:"1",\
      on_false:"0"\
    },\
    {\
    ...
    {\
      type:"minecraft:boolean",\
      key:"dialog_drop_notification_wither_skeleton",\
      label: {\
      ...
      initial:$(drop_notification_wither_skeleton),\
      on_true:"1",\
      on_false:"0"\
    },\
    {\
  ...
  actions:[\
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads:config/reset/drop_notifications"\
      }\
    }\
  ]\
}
