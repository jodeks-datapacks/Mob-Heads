...
type:"minecraft:multi_action",\ 
  ...
  [\
    ...
    {\
      ...
      step: 1,\
      key:"dialog_rarity_sulfur_cube",\
      label: {\
        "translate": "entity.minecraft.sulfur_cube",\
      },\
      initial: $(rarity_sulfur_cube)\
    },\
    {\
      type:"minecraft:number_range",\
      start: 0,\
