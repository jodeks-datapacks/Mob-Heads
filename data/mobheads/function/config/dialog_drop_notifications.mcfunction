...
type:"minecraft:multi_action",\ 
  ...
  actions:[\
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mobheads:config/reset/drop_notifications"\
      }\
    }\
  ]\
}
